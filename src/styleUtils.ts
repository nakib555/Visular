...
export const STYLE_GROUPS = {
  ...
  alignSelf: ["self-auto", "self-normal", "self-stretch", "self-start", "self-end", "self-center", "self-baseline"],
  justifyItems: ["justify-items-legacy", "justify-items-normal", "justify-items-stretch", "justify-items-start", "justify-items-end", "justify-items-center", "justify-items-self-start", "justify-items-self-end", "justify-items-left", "justify-items-right"],
  justifySelf: ["justify-self-auto", "justify-self-normal", "justify-self-stretch", "justify-self-start", "justify-self-end", "justify-self-center"],
