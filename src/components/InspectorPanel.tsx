...
export const CSS_HIERARCHY_DATA: CSSCategory[] = [
  ...
  {
    name: "WRITING MODES & FLOW DIRECTION",
    icon: AlignLeft,
    subCategories: [
      {
        ...
        properties: [
          ...
          { name: "direction", values: "ltr | rtl | initial | inherit" },
          {
      ...
      },
      {
        ...
        properties: [
          ...
          },
          {
            name: "mask-size",
            values:
              "<bg-size># | initial | inherit | revert | revert-layer | unset",
          },
          {
            name: "mask-composite",
            values:
  ...
  {
    name: "ADVANCED ANCHOR POSITIONING & ALIGNMENT",
    icon: Anchor,
    subCategories: [
      {
        name: "Anchor Positioning",
        properties: [
          { name: "anchor-name", values: "none | <dashed-ident># | initial | inherit | revert | revert-layer | unset" },
          { name: "anchor-scope", values: "none | all | <dashed-ident># | initial | inherit | revert | revert-layer | unset" },
          { name: "position-anchor", values: "<anchor-name> | auto | initial | inherit | revert | revert-layer | unset" }
        ]
      },
      {
        name: "Anchor Alignment",
        properties: [
          { name: "position-area", values: "none | auto | [ [ left | center | right | span-left | span-right | x-start | x-end | span-x-start | span-x-end | x-self-start | x-self-end | span-x-self-start | span-x-self-end | span-all ] || [ top | center | bottom | span-top | span-bottom | y-start | y-end | span-y-start | span-y-end | y-self-start | y-self-end | span-y-self-start | span-y-self-end | span-all ] ] | [ [ block-start | center | block-end | span-block-start | span-block-end | span-all ] || [ inline-start | center | inline-end | span-inline-start | span-inline-end | span-all ] ] | [ [ self-block-start | center | self-block-end | span-self-block-start | span-self-block-end | span-all ] || [ self-inline-start | center | self-inline-end | span-self-inline-start | span-self-inline-end | span-all ] ] | [ [ start | center | end | span-start | span-end | span-all ]{1,2} ] | initial | inherit | revert | revert-layer | unset" },
          { name: "position-try-fallbacks", values: "none | [ <dashed-ident> || <try-tactic> ]# | initial | inherit | revert | revert-layer | unset" },
          { name: "position-try-order", values: "normal | <built-in-fallback-order> | initial | inherit | revert | revert-layer | unset" },
          { name: "position-visibility", values: "always | anchors-visible | no-overflow | initial | inherit | revert | revert-layer | unset" }
        ]
      }
    ]
  },
...
export function InspectorPanel({
  ...
  const [layoutSubCategory, setLayoutSubCategory] = useState<
    "display" | "flex" | "grid" | "position" | "overflow"
  >("display");
  const [typographySubCategory, setTypographySubCategory] =
    useState<string>("basic");
  const [appearanceSubCategory, setAppearanceSubCategory] = useState<
    "colors" | "backgrounds" | "borders" | "blending"
  >("colors");
  const [effectsSubCategory, setEffectsSubCategory] = useState<
    "shadows" | "filters" | "masking" | "transparency"
  >("shadows");
  const [animationSubCategory, setAnimationSubCategory] = useState<
    | "transitions"
    | "transforms"
    | "legacyTransforms"
    | "keyframes"
    | "scrollDriven"
  >("transitions");
  const [interactivitySubCategory, setInteractivitySubCategory] = useState<
    "mouse" | "user" | "scrollControl" | "containerSnap" | "itemSnap" | "touch"
  >("mouse");
  const [mediaSubCategory, setMediaSubCategory] = useState<
    "fitting" | "rendering" | "shapes"
  >("fitting");
  const [expandedLayoutSections, setExpandedLayoutSections] = useState<
    Record<string, boolean>
  >({
    display: true,
    flex: true,
  ...
  const [expandedTypographySections, setExpandedTypographySections] = useState<
    Record<string, boolean>
  >({
    basic: true,
    sizing: true,
            ...
            <div className="bg-stone-50/50 border border-stone-200/50 rounded-2xl p-4 space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <PropertyControl
                  ...
                  onChange={(val) =>
                    updateTree((n) => ({
                      classes: setGroupClass(n.classes, "width", val),
                    }))
                  }
                  placeholder="Auto"
                />
                ...
                <PropertyControl
                  ...
                  onChange={(val) =>
                    updateTree((n) => ({
                      classes: setGroupClass(n.classes, "height", val),
                    }))
                  }
                  placeholder="Auto"
                />
        ...
        {inspectorSection === "layout" && (
          <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-3 duration-350">
            ...
            {(() => {
              ...
              const displayVal =
                getActiveGroupClass(selectedElement.classes, "display") || "";
              const isFlexContext =
                    ...
                    {expandedLayoutSections.flex && (
                      <div className="space-y-4 pt-3 animate-in fade-in duration-200">
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="justify-stretch">
                                    stretch
                                  </option>
                                  <option value="justify-items-left">
                                    left
                                  </option>
                                  <option value="justify-items-right">
                                    right
                                  </option>
                                </select>
                                <ChevronDown
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="flex-wrap-reverse">
                                    wrap-reverse
                                  </option>
                                </select>
                                <ChevronDown
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateArbitraryClass("gap-", e.target.value)
                                  }
                              ...
                              <p className="text-[9px] text-rose-700 leading-snug bg-rose-50/40 p-2 rounded-xl border border-rose-100/30 font-sans font-medium">
                                💡 **Gap Dual-Nature:** Spacing applies
                                column-wise in standard horizontal rows, and
                                row-wise in vertical columns (`flex-col`)
                                automatically.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="border-t border-stone-200/40 pt-4.5 space-y-4 font-sans select-none">
                          ...
                          {/* flex-grow & shrink */}
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[10px] text-stone-505 font-bold uppercase tracking-wider pl-1 font-mono">
                              flex-grow
                            </label>
                            <div className="grid grid-cols-2 gap-2">
                              <div className="relative">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateArbitraryClass("grow-", e.target.value)
                                }
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="basis-full">
                                    100% (full)
                                  </option>
                                  <option value="basis-1/2">50% (half)</option>
                                  <option value="basis-1/3">
                                    33.33% (third)
                                  </option>
                                  <option value="basis-1/4">
                                    25% (quarter)
                                  </option>
                                </select>
                                <ChevronDown
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateArbitraryClass("basis-", e.target.value)
                                }
                                className="w-full bg-white border border-stone-200 rounded-xl px-3 py-1.5 text-xs text-stone-700 shadow-xs focus:outline-none focus:border-rose-400 font-medium"
                              />
                            </div>
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <p className="text-[9px] text-rose-800 leading-relaxed bg-rose-50/40 p-2.5 rounded-xl border border-rose-100/30 font-medium">
                              👉 **Alignment Override:** Parent container's
                              `align-items` sets the default vertical alignment
                              for children; individual items can override it
                              with `align-self` directly.
                            </p>
                          </div>

                          {/* order */}
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[10px] text-stone-550 font-bold uppercase tracking-wider pl-1 font-mono font-bold">
                              order
                            </label>
                            <div className="grid grid-cols-2 gap-2 font-sans font-mono font-sans">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateArbitraryClass("order-", e.target.value)
                                }
                                className="w-full bg-white border border-stone-200 rounded-xl px-3 py-1.5 text-xs text-stone-700 shadow-xs focus:outline-none focus:border-rose-400 font-medium"
                              />
                            </div>
                      ...
                      <div className="space-y-4 pt-3 animate-in fade-in duration-200">
                        {!isGridContext ? (
                          <div className="bg-rose-50/30 border border-rose-100 rounded-xl p-3.5 text-center space-y-2">
                            ...
                            <p className="text-[10px] text-rose-600 leading-normal font-medium max-w-[210px] mx-auto">
                              To edit template columns, spans, rows, gaps, and
                              placement properties, change layout display type
                              to grid.
                            </p>
                            <button
                              type="button"
                          ...
                          <div className="space-y-3.5">
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="justify-items-normal">
                                    normal
                                  </option>
                                  <option value="justify-items-stretch">
                                    stretch
                                  </option>
                                  <option value="justify-items-center">
                                    center
                                  </option>
                                  <option value="justify-items-start">
                                    start
                                  </option>
                                  ...
                                  <option value="justify-items-legacy">
                                    legacy
                                  </option>
                                </select>
                                <ChevronDown
                            ...
                            <div className="flex flex-col gap-1.5">
                              <div className="flex items-center justify-between">
                                <label className="text-[10px] text-stone-505 font-bold uppercase tracking-wider pl-1 font-mono font-bold">
                                  item gap
                                </label>
                                <span className="text-[8px] text-rose-700 bg-rose-50 px-1 py-0.5 rounded font-bold uppercase tracking-wide">
                                  Dual-Nature
                              ...
                              <p className="text-[9px] text-rose-700 leading-snug bg-rose-50/40 p-2 rounded-xl border border-rose-100/30 font-sans font-medium">
                                💡 **Grid Gap Dual-Nature:** Spacing applies
                                column-wise and row-wise across cellular layouts
                                seamlessly.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="border-t border-stone-200/40 pt-4.5 space-y-4 font-sans select-none">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="col-span-full">
                                    col-span-full (all cols)
                                  </option>
                                </select>
                                <ChevronDown
                                  size={14}
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateArbitraryClass("col-", e.target.value)
                                }
                                className="w-full bg-white border border-stone-200 rounded-xl px-3 py-1.5 text-xs text-stone-700 shadow-xs focus:outline-none focus:border-rose-400 font-medium"
                              />
                            </div>
                          ...
                          <div className="flex flex-col gap-1.5 font-mono">
                            <label className="text-[10px] text-stone-505 font-bold uppercase tracking-wider pl-1 font-mono font-sans font-bold">
                              grid-row (spanning)
                            </label>
                            <div className="grid grid-cols-2 gap-2 font-sans font-mono font-sans">
                              <div className="relative">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateArbitraryClass("row-", e.target.value)
                                }
                                className="w-full bg-white border border-stone-200 rounded-xl px-3 py-1.5 text-xs text-stone-700 shadow-xs focus:outline-none focus:border-rose-400 font-medium"
                              />
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="relative">
                                ...
                                >
                                  <option value="">auto</option>
                                  <option value="justify-self-auto">
                                    auto
                                  </option>
                                  <option value="justify-self-normal">
                                    normal
                                  </option>
                                  <option value="justify-self-stretch">
                                    stretch
                                  </option>
                                  <option value="justify-self-start">
                                    start
                                  </option>
                                  <option value="justify-self-end">end</option>
                                  <option value="justify-self-center">
                                    center
                                  </option>
                                </select>
                                <ChevronDown
                            ...
                            {/* align-self */}
                            <div className="flex flex-col gap-1.5 font-mono">
                              <label className="text-[10px] text-stone-505 font-bold uppercase tracking-wider pl-1 font-sans font-bold">
                                align-self
                              </label>
                              <div className="relative font-sans">
                                <select
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <input
                              ...
                              value={(() => {
                                const cls = selectedElement.classes
                                  .split(/\s+/)
                                  .find(
                                    (c) =>
                              ...
                              onChange={(e) => {
                                ...
                                const currentTokens = selectedElement.classes
                                  ...
                                  .filter(Boolean);
                                let filtered = currentTokens.filter(
                                  (token) => !token.startsWith("[grid-area:"),
                                );
                                if (val) {
                                  filtered.push(`[grid-area:${val}]`);
                                }
                                updateTree((n) => ({
                                  classes: filtered.join(" "),
                                }));
                              }}
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="overflow-auto">
                                overflow-auto
                              </option>
                              <option value="overflow-hidden">
                                overflow-hidden
                              </option>
                              <option value="overflow-clip">
                                overflow-clip
                              </option>
                              <option value="overflow-visible">
                                overflow-visible
                              </option>
                              <option value="overflow-scroll">
                                overflow-scroll
                              </option>
                            </select>
                            <ChevronDown
          ...
          <div className="flex flex-col gap-5 animate-in fade-in slide-in-from-right-3 duration-350">
            ...
            {(() => {
              ...
              const updateArbitraryClass = (prefix: string, value: string) => {
                ...
                if (value && value.trim()) {
                  filtered.push(
                    `${prefix}[${value.trim().replace(/\s+/g, "_")}]`,
                  );
                }
                updateTree((n) => ({ classes: filtered.join(" ") }));
              };
              ...
              const getPropValue = (
                ...
                if (tailwindMap) {
                  const tokens = selectedElement.classes
                    .split(/\s+/)
                    .filter(Boolean);
                  for (const [twClass, realVal] of Object.entries(
                    tailwindMap,
                  )) {
              ...
              const setPropValue = (
                ...
                if (tailwindMap) {
                  ...
                  filtered = filtered.filter(
                    (token) => !twClasses.includes(token),
                  );
                }
                    ...
                    <div className="bg-stone-50/50 border border-stone-200/50 rounded-2xl p-3.5 space-y-3 shadow-sm animate-in fade-in duration-200">
                      ...
                      <div className="space-y-2">
                        <SegmentedControl
                          label="font-family"
                          value={
                            getPropValue("font-family", fontFamilyMap) ||
                            "sans-serif"
                          }
                          onChange={(val) =>
                            setPropValue("font-family", val, fontFamilyMap)
                          }
                          options={[
                        ...
                        <div className="flex gap-2">
                          <div className="relative flex-1">
                            ...
                            >
                              ...
                              <option value="weight style small-caps">
                                all active
                              </option>
                            </select>
                            <ChevronDown
                        ...
                        <div className="flex gap-2">
                          <div className="relative flex-1">
                            ...
                            >
                              <option value="">Default</option>
                              <option value="normal">normal</option>
                              <option value="ultra-condensed">
                                ultra-condensed
                              </option>
                              <option value="extra-condensed">
                                extra-condensed
                              </option>
                              <option value="condensed">condensed</option>
                              <option value="semi-condensed">
                                semi-condensed
                              </option>
                              <option value="semi-expanded">
                                semi-expanded
                              </option>
                              <option value="expanded">expanded</option>
                              <option value="extra-expanded">
                                extra-expanded
                              </option>
                              <option value="ultra-expanded">
                                ultra-expanded
                              </option>
                            </select>
                            <ChevronDown
                  ...
                  {typographySubCategory === "spacing" && (
                    <div className="bg-stone-50/50 border border-stone-200/50 rounded-2xl p-3.5 space-y-3 shadow-sm animate-in fade-in duration-200">
                      ...
                      <SegmentedControl
                        label="text-align"
                        value={
                          getPropValue("text-align", textAlignMap) || "left"
                        }
                        onChange={(val) =>
                          setPropValue("text-align", val, textAlignMap)
                        }
                        options={[
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                          <select
                            ...
                            onChange={(e) =>
                              updateArbitraryProperty("hyphens", e.target.value)
                            }
                            className="w-full appearance-none bg-white border border-stone-200 rounded-lg pl-2 pr-6 py-1.5 text-xs text-stone-700 cursor-pointer focus:outline-none font-medium"
                          >
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="normal">normal</option>
                            <option value="small-caps">small-caps</option>
                            <option value="all-small-caps">
                              all-small-caps
                            </option>
                            <option value="petite-caps">petite-caps</option>
                            <option value="all-petite-caps">
                              all-petite-caps
                            </option>
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="normal">normal</option>
                            <option value="none">none</option>
                            <option value="common-ligatures">
                              common-ligatures
                            </option>
                            <option value="no-common-ligatures">
                              no-common-ligatures
                            </option>
                            <option value="discretionary-ligatures">
                              discretionary-ligatures
                            </option>
                            <option value="historical-ligatures">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="proportional-nums">
                              proportional-nums
                            </option>
                            <option value="tabular-nums">tabular-nums</option>
                            <option value="diagonal-fractions">
                              diagonal-fractions
                            </option>
                            <option value="stacked-fractions">
                              stacked-fractions
                            </option>
                          </select>
                          <ChevronDown
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="full-width">full-width</option>
                            <option value="proportional-width">
                              proportional-width
                            </option>
                    ...
                    <div className="space-y-3 text-[11px] leading-relaxed text-stone-600">
                      <div>
                        <span className="font-semibold text-stone-800">
                          1. Unitless vs. Relative line-height Inheritance:
                        </span>{" "}
                        Using percentages or absolute font units evaluats a
                        fixed pixel value immediately. Descendants inherit this
                        computed value, leading to overlapping lines on larger
                        children. A unitless ratio (e.g.,{" "}
                        <code className="bg-stone-100 px-1 py-0.5 rounded font-mono">
                          1.5
                        </code>
                        ) recalculates dynamically on descendants.
                      </div>
                      <div>
                        <span className="font-semibold text-stone-800">
                          2. Relative Length Units:
                        </span>{" "}
                        Relative units scroll dynamically and recalculate
                        alongside child or parent{" "}
                        <code className="bg-stone-100 px-1 py-0.5 rounded font-mono">
                          font-size
                        </code>{" "}
                        updates.
                      ...
                      <div>
                        <span className="font-semibold text-stone-800">
                          3. white-space Constraints:
                        </span>{" "}
                        If{" "}
                        <code className="bg-stone-100 px-1 py-0.5 rounded font-mono">
                          nowrap
                        </code>{" "}
                        is declared, multi-line wrapping, breaking, balance
                        alignment, pretty styling, and hyphenation are bypassed.
                        Ellipsis overflow requires overflow hidden and a block
                        wrapper.
                      </div>
                      <div>
                        <span className="font-semibold text-stone-800">
                        ...
                        Font properties (ligatures, numeric alternates,
                        capitals) rely on underlying OpenType font tables to
                        function.
                      </div>
                    </div>
                  </div>
