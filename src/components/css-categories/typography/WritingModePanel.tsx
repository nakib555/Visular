...
export function WritingModePanel({ selectedElement, updateTree }: PanelProps) {
    ...
    <div className="bg-stone-50/50 border border-stone-200/50 rounded-2xl p-3.5 space-y-3 shadow-sm animate-in fade-in duration-200">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <select
              value={_parseArbitraryProperty("writing-mode")}
              onChange={(e) => _updateArbitraryProperty("writing-mode", e.target.value)}
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <select
              value={_parseArbitraryProperty("direction")}
              onChange={(e) => _updateArbitraryProperty("direction", e.target.value)}
              className="w-full appearance-none bg-white border border-stone-200 rounded-lg pl-2 pr-6 py-1.5 text-xs text-stone-700 cursor-pointer focus:outline-none font-medium"
            >
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <select
              value={_parseArbitraryProperty("text-orientation")}
              onChange={(e) => _updateArbitraryProperty("text-orientation", e.target.value)}
              className="w-full appearance-none bg-white border border-stone-200 rounded-lg pl-2 pr-6 py-1.5 text-xs text-stone-700 cursor-pointer focus:outline-none font-medium"
            >
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <select
              value={_parseArbitraryProperty("unicode-bidi")}
              onChange={(e) => _updateArbitraryProperty("unicode-bidi", e.target.value)}
              className="w-full appearance-none bg-white border border-stone-200 rounded-lg pl-2 pr-6 py-1.5 text-xs text-stone-700 cursor-pointer focus:outline-none font-medium"
            >
